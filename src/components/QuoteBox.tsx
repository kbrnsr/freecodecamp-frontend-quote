...
function QuoteBox() {
  return (
    <div className="QuoteBox" data-testid={constants.quoteBox} id={constants.quoteBox}>
      ...
      <button aria-label={constants.quoteNew} type="submit" className="QuoteNew" data-testid={constants.quoteNew} id={constants.quoteNew} />
      <a href="index" data-testid={constants.quoteTweet} id={constants.quoteTweet}>Tweet</a>
    </div>
  );
}
